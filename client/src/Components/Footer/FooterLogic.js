...
const FooterLogic = () => {
    ...
    const renderApisToLookUp = apisToLookUp.map((api) => (
        <H6
            key={api}
            style={{ lineHeight: '34px', cursor: 'pointer' }}
            text={api}
    ...
    const renderApisToCreate = apisToCreate.map((api) => (
        <H6
            key={api}
            style={{ lineHeight: '34px', cursor: 'pointer' }}
            text={api}
    ...
    const renderApisToValidate = apisToValidate.map((api) => (
        <H6
            key={api}
            style={{ lineHeight: '34px', cursor: 'pointer' }}
            text={api}
